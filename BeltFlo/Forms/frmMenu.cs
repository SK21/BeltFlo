...
namespace BeltFlo.Forms
{
    public partial class frmMenu : Form
    {
        ...
        private void btnHelp_Click(object sender, EventArgs e)
        {
            ...
            string pdf  = System.IO.Path.Combine(dir, "Help", "BeltFlo User Manual.pdf");
            string html = System.IO.Path.Combine(dir, "Help", "BeltFlo User Manual.html");
            string md   = System.IO.Path.Combine(dir, "Help", "BeltFlo User Manual.md");
        ...
        private void btnLoads_Click(object sender, EventArgs e)     => FormManager.ShowForm(new frmMenuLoads());
        ...
        private void btnScaleCal_Click(object sender, EventArgs e)  => FormManager.ShowForm(new frmMenuScaleCal());
